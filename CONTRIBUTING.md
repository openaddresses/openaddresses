...
They are called Processing Fields and Attribute Fields.

##### Processing Fields

Tag | Note |
--- | ---
`type` **required** | The type properties stores the format. It can currently be either `shapefile`, `shapefile-polygon`, `csv` or `geojson`
